"""
Ejemplo sencillo de visualización individual de tipos de variantes.

Este ejemplo muestra cómo generar un gráfico de tipos de variantes
...
def main():
    ...
    # Generar gráfico de tipos de variantes
    print("Generando gráfico de tipos de variantes...")
    fig = pyMut.variant_type_plot(
        figsize=(10, 6),
        title="Tipos de Variantes"
    )
    
    # Guardar el gráfico
    output_file = "variant_type_individual_example.png"
